...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Adjust the width of 'Tiket' and 'Status' columns */
        table th:nth-child(15), /* Target the 'Status' column */
        table th:nth-child(10) { /* Target the 'Tiket' column */
            width: 200px; /* Adjust this value to the desired width */
        }

        table td:nth-child(20), /* For the 'Status' column */
        table td:nth-child(10) { /* For the 'Tiket' column */
