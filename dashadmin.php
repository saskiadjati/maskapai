...
.banner {
    width: 100%;
    height: 60vh;
    background-image: url(https://cdn.medcom.id/dynamic/content/2017/07/19/731606/cover_maskapai_indonesia.jpg?w=1024);
...
<body>
    ...
    <header>
        <div class="container">
            ...
            <ul>
                <li class="active"><a href="dashadmin.php">Dashboard</a></li>
    ...
    <section class="about">
        <div class="container">
            <h3>About</h3>
            <p><strong>Pochina Airplanes</strong> is an organization that provides flight services for passengers or goods. 
